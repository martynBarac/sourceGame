...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_PRONE );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_LEAN_LEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_LEAN_RIGHT );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_LEAN_LEFT_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_LEAN_RIGHT_IDLE );
