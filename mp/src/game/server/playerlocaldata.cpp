...
BEGIN_SEND_TABLE_NOBASE( CPlayerLocalData, DT_Local )
	...
	SendPropInt		(SENDINFO(m_bProned), 1, SPROP_UNSIGNED),
	SendPropInt		(SENDINFO(m_bProning), 1, SPROP_UNSIGNED),
...
BEGIN_SIMPLE_DATADESC( CPlayerLocalData )
	...
	DEFINE_FIELD(m_bProned, FIELD_BOOLEAN),
	DEFINE_FIELD(m_bProning, FIELD_BOOLEAN),
