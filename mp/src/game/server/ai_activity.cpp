...
//===========================
	...
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_IDLE_PRONE );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_LEAN_LEFT );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_LEAN_RIGHT );
	ADD_ACTIVITY_TO_SR (ACT_HL2MP_LEAN_LEFT_IDLE);
	ADD_ACTIVITY_TO_SR (ACT_HL2MP_LEAN_RIGHT_IDLE);
