...
#ifndef FUNC_BREAKABLE_WALL_H
#define FUNC_BREAKABLE_WALL_H
#ifdef _WIN32
#pragma once
#endif
...
//#############################################################################
class CWallPane : public CBaseAnimating
{
public:
	DECLARE_CLASS(CWallPane, CBaseAnimating);

	static CWallPane* CreateWindowPane(const Vector &vecOrigin, const QAngle &vecAngles);
...
//  A breakable surface
//#############################################################################
class CBreakableWall : public CBreakable
{
	DECLARE_CLASS(CBreakableWall, CBreakable);
	DECLARE_DATADESC();
	DECLARE_SERVERCLASS();
