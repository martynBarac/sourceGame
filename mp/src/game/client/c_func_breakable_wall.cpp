...
class C_BreakableWall : public C_BaseEntity, public IBrushRenderer
{
public:
	DECLARE_CLIENTCLASS();
	DECLARE_CLASS(C_BreakableWall, C_BaseEntity);
	DECLARE_DATADESC();
...
BEGIN_DATADESC(C_BreakableWall)
...
bool C_BreakableWall::InLegalRange(int nWidth, int nHeight)
{
	return (nWidth < m_nNumWide && nHeight < m_nNumHigh &&
		nWidth >= 0 && nHeight >= 0);
}

bool C_BreakableWall::IsPanelSolid(int nWidth, int nHeight)
{
	return (BITS_PANEL_IS_SOLID & m_nPanelBits[nWidth][nHeight]) != 0;
}

bool C_BreakableWall::IsPanelStale(int nWidth, int nHeight)
{
	return (BITS_PANEL_IS_STALE & m_nPanelBits[nWidth][nHeight]) != 0;
}

void C_BreakableWall::SetPanelSolid(int nWidth, int nHeight, bool value)
{
...
void C_BreakableWall::SetPanelStale(int nWidth, int nHeight, bool value)
{
	if (!InLegalRange(nWidth, nHeight))
		return;
...
void C_BreakableWall::OnRestore()
{
	BaseClass::OnRestore();
...
//Receive datatable
IMPLEMENT_CLIENTCLASS_DT(C_BreakableWall, DT_BreakableWall, CBreakableWall)
...
// Gets at the cracked version of the material
//-----------------------------------------------------------------------------
void C_BreakableWall::FindCrackedMaterial()
{
...
// Output  :
//------------------------------------------------------------------------------
void C_BreakableWall::InitMaterial(WinEdge_t nEdgeType, int nEdgeStyle, char const* pMaterialName)
{
...
C_BreakableWall::C_BreakableWall()
{
	m_vNormal.Init();
	m_vCorner.Init();
	m_bIsBroken = false;
...
void C_BreakableWall::OnPreDataChanged(DataUpdateType_t updateType)
{
...
// Input  : bnewentity - 
//-----------------------------------------------------------------------------
void C_BreakableWall::OnDataChanged(DataUpdateType_t updateType)
{
...
bool C_BreakableWall::IsTransparent(void)
{
...
// Output  :
//------------------------------------------------------------------------------
int C_BreakableWall::DrawModel(int flags)
{
	if (!m_bReadyToDraw)
		return 0;
...
bool C_BreakableWall::RenderBrushModelSurface(IClientEntity* pBaseEntity, IBrushSurface* pBrushSurface)
{
...
// Output  :
//------------------------------------------------------------------------------
void C_BreakableWall::DrawRenderList(IBrushSurface* pBrushSurface)
{
...
// Output  :
//------------------------------------------------------------------------------
void C_BreakableWall::DrawRenderListHighlights(IBrushSurface* pBrushSurface)
{
	// Get width and height steps
	QAngle vAngles;
	VectorAngles(-1 * m_vNormal, vAngles);
...
// Output  :
//------------------------------------------------------------------------------
bool C_BreakableWall::HavePanel(int nWidth, int nHeight)
{
...
// Output  :
//------------------------------------------------------------------------------
void C_BreakableWall::UpdateEdgeType(int nWidth, int nHeight, int forceStyle /*=-1*/)
{
...
// Output  :
//--------------------------------------------------------------------------------
int C_BreakableWall::FindRenderPanel(int nWidth, int nHeight, WinSide_t nWinSide)
{
	for (unsigned short i = m_RenderList.Head(); i != m_RenderList.InvalidIndex(); i = m_RenderList.Next(i))
	{
...
// Output  :
//----------------------------------------------------------------------------------
int C_BreakableWall::FindFirstRenderTexture(WinEdge_t nEdgeType, int nStyle)
{
	for (unsigned short i = m_RenderList.Head(); i != m_RenderList.InvalidIndex(); i = m_RenderList.Next(i))
	{
...
// Output  :
//------------------------------------------------------------------------------
void C_BreakableWall::AddToRenderList(int nWidth, int nHeight, WinSide_t nSide, WinEdge_t nEdgeType, int forceStyle)
{
	// -----------------------------------------------------
...
// Output  :
//------------------------------------------------------------------------------
void C_BreakableWall::DrawSolidBlocks(IBrushSurface* pBrushSurface)
{
	CMatRenderContextPtr pRenderContext(materials);
...
// Output  :
//------------------------------------------------------------------------------
void C_BreakableWall::DrawOneBlock(IBrushSurface* pBrushSurface, IMesh* pMesh,
...
// Output  :
//------------------------------------------------------------------------------
void C_BreakableWall::DrawOneEdge(IBrushSurface* pBrushSurface, IMesh* pMesh,
...
// Output  :
//------------------------------------------------------------------------------
void C_BreakableWall::DrawOneHighlight(IBrushSurface* pBrushSurface, IMesh* pMesh,
	CMeshBuilder *pMeshBuilder, const Vector &vStartPos, const Vector &vWStep,
	const Vector &vHStep, WinSide_t nEdge)
{
...
bool C_BreakableWall::ShouldReceiveProjectedTextures(int flags)
{
	return false;
}
...
//------------------------------------------------------------------------------
class CBreakableWallProxy : public CEntityMaterialProxy
{
public:
	CBreakableWallProxy();
	virtual ~CBreakableWallProxy();
...
CBreakableWallProxy::CBreakableWallProxy()
{
...
bool CBreakableWallProxy::Init(IMaterial *pMaterial, KeyValues *pKeyValues)
{
	bool foundVar;
...
void CBreakableWallProxy::OnBind(C_BaseEntity *pC_BaseEntity)
{
	C_BreakableWall *pEnt = dynamic_cast< C_BreakableWall * >(pC_BaseEntity);
	if (!pEnt)
	{
		return;
	}
...
IMaterial *CBreakableWallProxy::GetMaterial()
{
	if (!m_BaseTextureVar)
		return NULL;
...
EXPOSE_INTERFACE(CBreakableWallProxy, IMaterialProxy, "BreakableWall" IMATERIAL_PROXY_INTERFACE_VERSION);
